...
const part1 = require('./verbalTopicsDataPart1');
const part2 = require('./verbalTopicsDataPart2');

const topicsData = [...part1, ...part2];

const MONGODB_URI = process.env.MONGO_URI;

const seedVerbalTopics = async () => {
  try {
    if (!MONGODB_URI) {
    ...
    console.log('Successfully seeded ' + count + ' verbal topics.');
    process.exit(0);
  } catch (error) {
    console.error('Error seeding verbal topics:', error);
    process.exit(1);
  }
};
